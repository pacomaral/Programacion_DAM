...
public class Jugador {
	...
	public void crearApodo(){
		String apodoCreado;
		//Pasamos a minúsculas las propiedades que utilizaremos en el método
		this.nombre = nombre.toLowerCase();
		this.apellido1 = apellido1.toLowerCase();
		this.apellido2 = apellido2.toLowerCase();
				
		//Creamos los arrays con los carácteres de las cadenas anteriores
		char[] array_nombre = nombre.toCharArray();
		char[] array_apellido1 = apellido1.toCharArray();
		char[] array_apellido2 = apellido2.toCharArray();
