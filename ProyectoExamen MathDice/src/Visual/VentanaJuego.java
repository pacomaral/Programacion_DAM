...
public class VentanaJuego extends JFrame {
	...
	private VentanaJuego referencia;
	...
	//JLabels donde asignaremos las imágenes de los dados correspondientes
	private JLabel dado1, dado2, dado3, dado4, dado5, dado6;
	
	//Objeto de la clase random para generar los valores aleatorios
	...
	public VentanaJuego() {
		...
		botonComprobar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				botonReintentar.setEnabled(true); 												//Activamos el botonReintentar
			}
		});
