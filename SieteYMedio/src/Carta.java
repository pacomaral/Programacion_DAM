...
public class Carta {
    ...
    **/
	...
	//CONSTANTES  (utilizando static final, no podran variar en todo el programa)
	...
	//CONSTRUCTOR: mismo nombre que la classe pero no palabra reservada class // Punto de entrada que se ejecuta al crear un objeto de tipo carta
	
	public Carta() {
		System.out.println("Se ha creado una carta");
	...
	*/
	...
	public void setNumero(int numero){
		...
		if (numero<1){
			this.numero=1;}			//Con this.numero hacemos referencia a la clase Carta
		else if (numero>12){
			this.numero=12;}
		else{
			this.numero=numero;}
