...
public class VentanaLogin extends JFrame {
	...
	public VentanaLogin(EditarApodo v2) {						//Parámetro para acceder a v2 desde v1
		...
		cajaEdad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0){
				//Acción a realizar al presionar intro
		...
		botonCrearjugador.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {																			
				try{
					...
					v2.setJugador_v2(jug1); 																//Importamos el objeto a la ventana2
					v2.setVisible(true); 																	//Hacemos visible v2
				}
				catch(Exception e){
	...
	public boolean comprobarSiHayValor(String t){
		if (t.length() == 0){
			return false;								//False = en blanco
		}
		else{
			return true;								//True = hay valores
		}
	}
