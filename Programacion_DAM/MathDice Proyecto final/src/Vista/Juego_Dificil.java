...
public class Juego_Dificil extends JPanel {
	...
	//Método para pasar los objetos desde la ventana de acceso
	public void setConexion_vJuegoDificil(ConexionBD conex, Control_BD control){				
	...
	public void msgFinal(){
		if(puntuacion > jug1.getPuntuacionMax()){									//Si la puntuación es mayor que la máxima del jugador, la asignamos
    		...
    		//Nos conectamos y actualizamos la puntuacionMax de la BBDD
    		this.conectarBD();
    		controlBD.actualizarPuntuacion(jug1, jug1.getPuntuacionMax());
    	}
	...
	class ListenerDados implements MouseListener{
		...
		public void mouseClicked(MouseEvent e) {
			...
			if(tocaNumero){
				...
				tocaNumero=false;													
				tocaOperacion=true;
				cajaOperaciones.setText(String.valueOf(resultadoOperaciones));			//Mostramos el resultado actual
